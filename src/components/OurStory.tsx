...
const countries = [
  ...
  },
  {
    ...
    flag: '🇨🇿',
    landmark: '🏰',
    description: 'Histoire et culture tchèque',
  },
  {
    code: 'BE',
    name: 'Belgique',
  ...
  },
  {
    ...
    flag: '🇲🇪',
    landmark: '🏰',
    description: 'Paysages montagneux et patrimoine historique',
  },
  {
    code: 'MCN',
    ...
    x: 55,
    y: 81,
    image: '/macedoine_du_nord.jpg',
    flag: '🇲🇰',
    landmark: '🏰',
    description: 'Culture et histoire balkanique',
  },
  {
    code: 'CR',
    name: 'Croatie',
  ...
  },
  {
    ...
    flag: '🇱🇻',
    landmark: '🏞️',
    description: 'Paysages verts et côtes de la mer Baltique',
  },
  {
    code: 'LTN',
    name: 'Lituanie',
    ...
    flag: '🇱🇹',
    landmark: '🏞️',
    description: 'Forêts et patrimoine historique',
  },
  {
    code: 'SV',
    name: 'Slovénie',
    ...
    flag: '🇸🇮',
    landmark: '🏔️',
    description: 'Montagnes, lacs et culture slovène',
  },
  {
    code: 'SB',
    name: 'Serbie',
    ...
    flag: '🇷🇸',
    landmark: '🏰',
    description: 'Histoire et culture serbe',
  },
];
