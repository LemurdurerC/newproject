...
+33 6 22 81 93 03 Clémence (témoin)</span>
                                <span className="group-hover:text-green-200 transition-colors duration-200">Pour toute question ou message que vous ne voudriez pas envoyer directement aux futurs mariés, la super équipe des témoins est là pour vous. Clémence centralisera vos messages.</span>
              </div>
